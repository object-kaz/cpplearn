...
2. **类型**
    * 单向链表
        <img src="images/单向链表.png" width="60%">
    * 双向链表
        <img src="images/双向链表.png" width="60%">
...
3. 在链表末尾上添加节点
    ...
    2. 让最后一个节点的 `next` 指向空节点。
        <img src="images/单向链表_末尾加节点.png" width="60%">
4. 在中间加节点
    1. 遍历到上一个节点 `prev_ptr` ，即插入点之前的节点。
    2. 让空节点 `new_node` 的 `next` 指向上一个节点 `prev_ptr` 的 `next` 。
        <img src="images/单向链表_中间加节点1.png" width="60%">
    3. 让上一个节点 `prev_ptr`  的 `next` 指向空节点 `new_node` 。
        <img src="images/单向链表_中间加节点2.png" width="60%">